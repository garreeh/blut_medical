      ...
      <li class="dropdown"><a href="#">
        ...
        <ul>
          ...
          if (isset($_SESSION['client_id'])) {
            ...
            ?>
            <li><a class="nav-link scrollto" href="/blut_medical/views/customer/customer_login_form.php">Login</a></li>
        ...
        if (isset($_SESSION['client_id'])) {
          ?>
        <li><a class="nav-link" href="/blut_medical/views/customer/customer_add_to_cart.php">
